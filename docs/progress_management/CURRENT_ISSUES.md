...
2. **Issue管理のルール**
   ...
   - **次回使用ID**: I063（2025-09-14時点・I062作成）
...
| I062 | FCO v2.0とダッシュボード統合・論文再現テストFCO対応 | FCOエンジン実装完了後のダッシュボード統合が未実装・Boulder lppls統合済みのFCOエンジンをダッシュボードに反映・DS-LPPLS Confidence/Trust指標の表示・126窓分析結果の可視化・論文再現テスト（1987年ブラックマンデー）のFCO対応実装・既存LPPLとFCO方式の比較検証・100/100スコア維持確認必須 | 2025-09-12 | ダッシュボード機能・FCO統合・論文再現 | 🔄 部分実装中 |

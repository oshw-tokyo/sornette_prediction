...
| Issue ID | タイトル | 詳細 | 発生日 | 影響範囲 | 担当 |
|----------|---------|------|--------|----------|------|
| I001 | β値の系統的誤差 | 論文では0.33であるべきβ値が0.36程度になる。複数初期値での最適化でも改善せず。**関連論文**: papers/sornette_2004_0301543v1...pdf 式(54), 理論値β=0.33±0.03 | 2025-01-22 | フィッティング精度全般 | Claude |
...
**次のアクション**: 
1. Differential Evolutionの実装テスト
2. パラメータ制約の見直し
